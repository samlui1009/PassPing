...
Much of this project was purely focused on developing the frontend, and to learn and understand how Chrome extensions work under the hood, which will be explained further down in this README.

In terms of developing the frontend, I wanted to use a technology that I had previously utilized. As such, I integrated React + Vite. Both of these tools have been used extensively in previous projects for frontend development, and I appreciated their ease in rapid prototyping with components that are designed for reusability. 
